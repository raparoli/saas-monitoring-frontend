...
import { Search, Filter, Users, HardDrive, Calendar, Eye } from 'lucide-react';
import { Customer, SortField } from '../types';
import { customers } from '../constants';
import { getFilteredCustomers, getSortedCustomers, formatStorageGB, formatDate, getUtilizationColor } from '../utils';
  ...
  return (
    <div className="space-y-6 mt-0">
      <div>
        ...
        <p className="text-muted-foreground">Monitor and manage all Acronis customers and their usage</p>
      </div>
        ...
        <CardContent>
          <div className="flex flex-col lg:flex-row lg:items-center space-y-4 lg:space-y-0 lg:space-x-4">
            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3 flex-1">
              ...
              <Select value={storageFilter} onValueChange={setStorageFilter}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="1000">Above 1 TB</SelectItem>
                  <SelectItem value="5000">Above 5 TB</SelectItem>
                  <SelectItem value="10000">Above 10 TB</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <label htmlFor="showDisabled" className="text-sm">Show disabled customers</label>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Click on any customer to view detailed information</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
